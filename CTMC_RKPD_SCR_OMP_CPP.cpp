...
class Electron{
	public:
		DATA parameters;
                Electron(int z_electron, long double m_electron, int z_target, long double m_target, int N_electron, long double* Amplitude, long double Wavelength, long double PulseWidth, long double Polarisation_phase ,waveformType eWaveform) {
...
int main(int argc, char* argv[]){
	...
	t=clock();
		...
		class Electron atom(z_electron, m_electron, z_target, m_target, N_electron, Amplitude, Wavelength, PulseWidth, M_PI*Polarisation_Phase/180 , Gaussian);
