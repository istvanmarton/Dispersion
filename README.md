...
2. 'Electron_Energy.txt' that is the output of the 'CTMC_RKPD_SCR_OMP_CPP_GDD' file, although the code requires some modification to produce the necessary file. The following lines in the 'collision_process' function should be uncommented:
   1. //FILE *fp;
