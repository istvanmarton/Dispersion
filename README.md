...
## Asymmetry_Map.gnu
The 'Asymmetry_Map.gnu' script plots the asymmetry maps, namely the Fig 7 in the article. As input it needs the 'Asymmetry_...' files generated by the 'Asymmetry.m' script. The output is 'Asymmetry_Map.eps'.
