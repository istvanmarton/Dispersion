...
The names of .jpg files showing the temporal profile of the electric field has the following form: 'Graph_1e+15Wcm_7fs_0CEP0GDD_0TOD_0FOD.jpg'. Apart from the CEP, the file name contains the properties of the pulse it depicts, similarly to the previous one. The depicted electric fields has 0 degrees CEP values and therefore the number of files are equal with the number of dispersion values in the 'value' vector.<br>
